...
func main() {
	...
	goga.TexSingleObjReport("/tmp/goga", "tmp_prob2", "probNine", 10, true, []*goga.Optimiser{opt})
	goga.TexSingleObjReport("/tmp/goga", "prob2", "probNine", 10, false, []*goga.Optimiser{opt})
}

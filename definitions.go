...
type PopOrdGen_t func(pop Population, ninds, nbases int, noise float64, args interface{}, nints int) Population

// PopFltGen_t defines function to generate population of float point numbers
type PopFltGen_t func(pop Population, ninds, nbases int, noise float64, args interface{}, frange [][]float64) Population

// PopStrGen_t defines function to generate population of strings
type PopStrGen_t func(pop Population, ninds, nbases int, noise float64, args interface{}, pool [][]string) Population

// PopKeyGen_t defines function to generate population of keys (bytes)
type PopKeyGen_t func(pop Population, ninds, nbases int, noise float64, args interface{}, pool [][]byte) Population

// PopBytGen_t defines function to generate population of bytes
type PopBytGen_t func(pop Population, ninds, nbases int, noise float64, args interface{}, pool [][]string) Population

// PopFunGen_t defines function to generate population of functions
type PopFunGen_t func(pop Population, ninds, nbases int, noise float64, args interface{}, pool [][]Func_t) Population
